...
- <span style = "color:lightyellow">1 레이어 : 1개 (1)</span> 
- <span style = "color:lightyellow">2 레이어 : 7개 (1 + 6)</span>
- <span style = "color:lightyellow">3 레이어 : 19개 (7 + 12)</span>
- <span style = "color:lightyellow">4 레이어 : 37개 (19 + 18)</span>

그리고 이는 각 레이어의 `가장 높은 숫자의 방`을 의미하기도 한다. 따라서 이 규칙에 따라 **<u>찾으려는 방의 숫자가 어떤 범위의 레이어에 속하는지만 알아내면</u>** 답이 나온다. 
