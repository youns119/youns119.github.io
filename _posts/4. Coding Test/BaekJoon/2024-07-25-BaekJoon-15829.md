---
title:  "[BaekJoon 15829][🟤2] Hashing"
...
간단해 보이지만 의외로 하나만 잘못 써도 부분 점수 밖에 얻지 못하는 경우가 발생한다. 특히나 곱해지는 값이 31의 거듭제곱으로 계속해서 더해지기 때문에, 순식간에 `long long`의 범위를 넘으므로, **<u>자료형과 Modular 연산의 특징을 잘 생각해서 풀어야 완전히 통과할 수 있다.</u>**
