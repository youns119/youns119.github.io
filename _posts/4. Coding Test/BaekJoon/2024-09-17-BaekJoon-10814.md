...
- <span style="color:lightblue">첫 번째 풀이 : `36ms`</span>
- <span style="color:lightblue">두 번째 풀이 : `36ms`</span>
- <span style="color:lightblue">세 번째 풀이 : `24ms`</span>

그래도 가장 의도가 보이면서 가독성이 좋은건 두 번째 풀이라고 볼 수 있다. `stable_sort`를 사용함으로써 원래 상대 순서를 보존하겠다는 의도가 보이기 때문이다.
