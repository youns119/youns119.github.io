---
title:  "[BaekJoon 2609][🟤1] 최대공약수와 최소공배수"
...
---
# 💭 후기
가장 기본적인 최대공약수, 최소공배수를 구하는 문제라 한 번 되짚어보고자 포스팅을 만들었다. 

`유클리드 호제법`은 이런 상황에서 많이 쓰이기도 하고, 시간 복잡도 또한 `피보나치 수열` 같은 최악의 경우만 아니라면 `O(log N)`를 보장하니 잘 기억해두도록 하자.
